            ...
            <IonCol size="12" size-md="6" size-lg="4">
              <div style={{textAlign: 'center', gap: 8, display: 'flex', flexDirection: 'column'}}>
                ...
                <div>
                  ...
                  <a href='/register' style={{color: "#F58B54"}}> Sign in.</a>
                </div>
              </div>
              {error && (
              ...
              <IonList>
                ...
                <IonItem>
                  <div style={{gap: 8, display: 'flex', alignItems: 'center', marginTop: 10}}>
                    <label>
                      <input type="checkbox"/>
                      <span style={{marginLeft: 4}}>I agree to the terms and conditions</span>
                    </label>
                  </div>
                </IonItem>
